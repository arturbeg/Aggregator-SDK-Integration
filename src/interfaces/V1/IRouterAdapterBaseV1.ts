...
/**
 * Represents the authentication information required for AEVO protocol.
 * @property version the version identifier for the signature.
 * @property evmAddress the EVM address of user being authenticated.
 * @property dydxEip712Sig raw hex string representing signed EIP712 data required for derivation.
 */
export type DydxAuth = {
  version: number
  evmAddress: `0x${string}`
  dydxEip712Sig: `0x${string}`
}
 ...
 * @property minLimitPositionSize The minimum position size for limit orders
...
export type GenericStaticMarketMetadata = {
  ...
  minLimitPositionSize: FixedNumber
  maxPrecision: number
 ...
 * @property tif The time in force.
 * @property slippage The max slippage for the trade in % terms.
...
export type AccountInfoData<T extends ProtocolId> = T extends 'GMXV2'
  ...
  : T extends 'HL' | 'ORDERLY'
    ...
    : T extends 'AEVO'
      ...
      : T extends 'DYDXV4'
        ? {
            equity: FixedNumber // The equity of the account
            freeCollateral: FixedNumber // The free collateral
            marginUsagePercent: FixedNumber // The margin usage percentage
          }
        : T extends 'SYNFUTURES'
          ? {
              inPositionUsd: FixedNumber // The amount in position in USD
              inOpenOrderUsd: FixedNumber // The amount in open orders in USD
              inLiquidityUsd: FixedNumber // The amount in liquidity in USD
              accountBalanceUsd: FixedNumber // The account balance in USD
              storedCollateral: StoredCollateralData<'SYNFUTURES'>
              lockedCollateral: StoredCollateralData<'SYNFUTURES'>
              totalCollateral: StoredCollateralData<'SYNFUTURES'>
            }
          : T extends 'PERENNIAL'
            ? {
                accountEquity: FixedNumber // The equity of the account.
